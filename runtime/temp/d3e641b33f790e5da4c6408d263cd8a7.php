<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:108:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\duowan\public/../application/admin\view\play\index.html";i:1570522267;s:103:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\duowan\application\admin\view\template\layout.html";i:1570774066;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-header">
                <div>
                    <a title="新增" class="btn btn-primary btn-sm add" data-href="<?php echo url('play/add'); ?>">
                        新增
                    </a>
                </div>
            </div>
                ...
                <table class="table table-hover table-bordered datatable" width="100%">
                 ...
                 <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td class="td-do">
                            <a data-href="<?php echo url('play/edit',array('id'=>$vo['id'])); ?>"
                               class="btn btn-primary btn-xs edit" title="修改">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-danger btn-xs del"
                               title="删除"  data-url="<?php echo url('play/del',array('id'=>$vo['id'])); ?>">
