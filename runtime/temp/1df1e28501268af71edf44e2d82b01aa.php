<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:109:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\duowan\public/../application/admin\view\other\index.html";i:1570591288;s:103:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\duowan\application\admin\view\template\layout.html";i:1569227915;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input  id="text" name="text" value="<?php echo (isset($info['text']) && ($info['text'] !== '')?$info['text']:''); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-6">
                                <div class="input-group">
                                    ...
                                    <input  type="text" id="purl" value="<?php echo (isset($info['purl']) && ($info['purl'] !== '')?$info['purl']:''); ?>" class="form-control" >
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('.add-other').click(function(){
         ...
         var url = "<?php echo url('other/add'); ?>";
