    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-header">
                <div>
                    <a title="新增" class="btn btn-primary btn-sm user-add" data-href="<?php echo url('user/add'); ?>">
                        新增
                    </a>
                </div>
            </div>
            ...
            <div class="box-body table-responsive">
                <table class="table table-hover table-bordered datatable" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="label label-<?php if($item['status']==1): ?>success<?php else: ?>danger<?php endif; ?> AjaxButton" title="<?php if($item['status']==1): ?>点击禁用<?php else: ?>点击启用<?php endif; ?>" data-id="<?php echo $item['id']; ?>" data-confirm="1" data-url="disable.html"><?php echo $item['admin_status_text']; ?></a>
                        </td>
                        <td class="td-do">
                            <a data-href="<?php echo url('user/edit',array('id'=>$item['id'])); ?>"
