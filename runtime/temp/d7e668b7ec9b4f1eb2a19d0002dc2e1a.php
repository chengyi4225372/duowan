            ...
            <form id="dataForm" class="form-horizontal dataForm" action="" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="fields-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group iconpicker-container">
                                    <?php if(is_array($roles) || $roles instanceof \think\Collection || $roles instanceof \think\Paginator): if( count($roles)==0 ) : echo "" ;else: foreach($roles as $key=>$item): ?>
                                    <input class="checkbox-inline checkbox" <?php echo $item['checked']; ?> type="checkbox"
                                           name="parent_id[]" id="parent_<?php echo $item['id']; ?>" value="<?php echo $item['id']; ?>"/>
                                    <label  style="margin:10px 20px 10px 3px;cursor: pointer;"  for="parent_<?php echo $item['id']; ?>"><?php echo $item['name']; ?></label>
                        ...
                        <div class="form-group">
                            <label for="nickname" class="col-sm-2 control-label">姓名或昵称</label>
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                    <input maxlength="20" id="nickname" name="nickname" value="<?php echo (isset($info['nickname']) && ($info['nickname'] !== '')?$info['nickname']:''); ?>" class="form-control" placeholder="请输入用户姓名或昵称">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group file-caption-main">
                                    <div tabindex="500" class="form-control file-caption  kv-fileinput-caption">
                                        <div class="file-caption-name" id="input-filename-avatar">
                                        </div>
                                    </div>
                                    <div class="input-group-btn">
                                        <div tabindex="500" class="btn btn-primary btn-file">
                                            ...
                                            <input type="file" class="form-input-image" data-preview="image-preview-avatar" data-showname="input-filename-avatar" name="avatar" id="avatar">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="input-group file-caption-main">
                                    <img id="image-preview-avatar" src="<?php echo (isset($info['avatar']) && ($info['avatar'] !== '')?$info['avatar']:''); ?>" style="max-width: 150px;max-height: 150px">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
