            ...
            <div class="box-body table-responsive">
                <table class="table table-hover table-bordered datatable" width="100%">
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $item['avatar']; ?>" style="max-height: 45px;max-width: 45px;"></td>
                        <td><?php echo $item['name']; ?></td>
                        <td><?php echo $item['nickname']; ?></td>
                        <td>
                            <?php if(is_array($item['adminGroup']) || $item['adminGroup'] instanceof \think\Collection || $item['adminGroup'] instanceof \think\Paginator): if( count($item['adminGroup'])==0 ) : echo "" ;else: foreach($item['adminGroup'] as $key=>$itemson): ?>
                            <small class="label bg-blue"><?php echo $itemson['adminGroup']['name']; ?></small>
