...
CREATE TABLE `bear_admin_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8mb4 COMMENT='后台用户操作日志表';
...
CREATE TABLE `bear_admin_log_datas` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8mb4 COMMENT='后台用户操作日志数据表';
...
INSERT INTO `bear_users` VALUES ('9', '0', 'testing001', '1', '1570717343', '1570505487', '1570505847', '1570505847', 'c4c309fea833fe9f4333ecd3a69a256c', '604800');
